    ...
    <>
      ...
      <Section padding="none" className="bg-brand-navy pt-[108px] pb-16">
        <div className="mx-auto max-w-2xl text-center pt-14 pb-4">
          ...
          {hero?.desc && <p className="mt-4 text-white/50 text-[15px]">{hero.desc}</p>}
      ...
      <Section theme="light" padding="md">
        ...
        {!isSearching && destaque && (
          <article className="group mb-10 rounded-3xl overflow-hidden border border-border bg-white hover:border-brand-orange/25 hover:shadow-2xl hover:shadow-black/[0.08] transition-all duration-300">
            <div className="grid lg:grid-cols-[1.6fr_1fr] items-stretch">
              ...
              <div className="p-3 sm:p-6 lg:p-10 flex flex-col justify-center">
                ...
                <h2 className="font-extrabold text-brand-navy text-display-lg leading-snug mb-3 lg:mb-4">
                  {destaque.title}
                </h2>
                <p className="text-brand-navy/60 text-[15px] lg:text-base leading-relaxed mb-5 lg:mb-6">
                  {destaque.excerpt}
                </p>
                {/* Autor + data */}
                <div className="flex items-center gap-2 mb-4 lg:mb-5 text-[13px]">
                  {destaque.author && (
        ...
        {grid.length > 0 ? (
              ...
              {visible.map((post) => (
                ...
                >
                  ...
                  <div className="p-2 md:p-4">
                    ...
                    <p className="text-brand-navy/55 text-sm leading-relaxed line-clamp-2 mb-4">
                      {post.excerpt}
                    </p>
                    <div className="pt-3 border-t border-border flex items-center gap-2 text-[12px]">
                      {post.author && (
          ...
          <div className="py-20 text-center text-brand-navy/40 text-sm">{t("grid.noResults")}</div>
        )}
      </Section>
    </>
  );
