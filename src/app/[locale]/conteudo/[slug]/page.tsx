...
export default async function ArtigoPage({ params }: Props) {
  ...
  return (
    <main>
      {/* ── Hero ── */}
      <section className="bg-[#0D2E38] pt-[108px] pb-16">
        <Container>
          <div className="max-w-3xl pt-14 pb-16">
            ...
            <div className="flex items-center gap-2 text-[11px] text-white/40 mb-8">
              ...
              <span>/</span>
              <span className="text-[#FA8400]">{post.categoria}</span>
            </div>

            <div className="flex items-center gap-3 mb-6">
              <span className="inline-flex items-center rounded-full bg-[#FA8400]/15 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.2em] text-[#FA8400]">
                {post.categoria}
              </span>
            ...
            >
              ...
              <div>
                <div className="text-white text-sm font-semibold leading-tight group-hover/autor:text-[#FA8400] transition-colors">
                  {post.autor.nome}
                </div>
        ...
        <Container>
          <div className="relative aspect-[4/3] sm:aspect-video lg:aspect-[21/9] rounded-2xl lg:rounded-3xl overflow-hidden">
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0D2E38]/30 via-transparent to-transparent" />
          </div>
        </Container>
      </section>
          ...
          <div className="grid lg:grid-cols-[1fr_320px] gap-16 items-start">
            ...
            <article className="prose-custom max-w-none">
              {post.corpo.map((paragrafo, i) => (
                <p
                  key={i}
                  className="text-[#0D2E38]/80 text-[1.0625rem] leading-[1.85] mb-6 last:mb-0"
                >
                  {paragrafo}
                </p>
              ))}
            ...
            <aside className="sticky top-28 space-y-8">
              ...
              <div className="rounded-2xl border border-[#E8E6E1] bg-white p-6">
                <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#0D2E38]/40 mb-4">
                  Sobre o autor
                </div>
                <Link
                  href={`/conteudo/autor/${post.autor.slug}`}
                ...
                >
                  ...
                  <div>
                    <div className="font-bold text-[#0D2E38] text-sm leading-tight group-hover/autor:text-[#FA8400] transition-colors">
                      {post.autor.nome}
                    </div>
                    <div className="text-[#0D2E38]/50 text-[11px] mt-0.5">{post.autor.cargo}</div>
                  </div>
                </Link>
                <p className="text-[#0D2E38]/55 text-[13px] leading-relaxed mb-4">
                  {post.autor.bio}
                </p>
                <Link
                  href={`/conteudo/autor/${post.autor.slug}`}
                  className="text-[12px] font-semibold text-[#FA8400] hover:underline"
                >
              ...
              <div className="rounded-2xl border border-[#E8E6E1] bg-white p-6">
                ...
                <div className="flex gap-2">
                  <a
                    ...
                    className="flex items-center gap-2 rounded-full border border-[#E8E6E1] px-4 py-2 text-[11px] font-semibold text-[#0D2E38]/60 hover:border-[#0077B5] hover:text-[#0077B5] transition-all"
                  >
                    LinkedIn
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 rounded-full border border-[#E8E6E1] px-4 py-2 text-[11px] font-semibold text-[#0D2E38]/60 hover:border-[#0D2E38] hover:text-[#0D2E38] transition-all"
                  >
                    X / Twitter
                  </a>
                </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {relacionados.map((r) => (
                <Link
                  ...
                  className="group rounded-2xl overflow-hidden border border-[#E8E6E1] bg-[#F5F4EF] hover:border-[#FA8400]/25 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/[0.06] transition-all duration-300"
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <span className="text-[11px] text-[#0D2E38]/40">{r.data}</span>
                    </div>
